const stockItems = [
  ...
  // 子ども用品
  { id: 18, name: "粉ミルク・液体ミルク", category: "子ども用品", calcType: "fixed", value: 1, unit: "缶", conditions: ["child"] },
  { id: 19, name: "おむつ", category: "子ども用品", calcType: "fixed", value: 8, unit: "枚", conditions: ["child"] },
  { id: 20, name: "離乳食・子ども用食品", category: "子ども用品", calcType: "fixed", value: 3, unit: "食", conditions: ["child"] },

  // 女性用品
  { id: 21, name: "生理用品", category: "女性用品", calcType: "fixed", value: 1, unit: "セット", conditions: ["female"] },
  { id: 22, name: "サニタリーショーツ", category: "女性用品", calcType: "fixed", value: 2, unit: "枚", conditions: ["female"] },

  // 高齢者用品
  { id: 23, name: "介護食", category: "高齢者用品", calcType: "fixed", value: 3, unit: "食", conditions: ["elderly"] },
  { id: 24, name: "常備薬・お薬手帳", category: "高齢者用品", calcType: "fixed", value: 1, unit: "式", conditions: ["elderly"] },
  { id: 25, name: "大人用おむつ", category: "高齢者用品", calcType: "fixed", value: 4, unit: "枚", conditions: ["elderly"] },
];
